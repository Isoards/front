        ...
        <div className={styles.infoSection}>
          <div className={styles.box}>
            <div className={styles.basicInfo}>
              <p><span className={styles.label}>이름</span> {patientInfo.patientName || '정보 없음'}</p>
              <p><span className={styles.label}>성별</span> {patientInfo.patientGender || '정보 없음'}</p>
              <p><span className={styles.label}>생년월일</span> {patientInfo.patientBirthDate || '정보 없음'}</p>
              <p><span className={styles.label}>키</span> {patientInfo.patientHeight ? `${patientInfo.patientHeight}cm` : '정보 없음'}</p>
              <p><span className={styles.label}>몸무게</span> {patientInfo.patientWeight ? `${patientInfo.patientWeight}kg` : '정보 없음'}</p>
              <p><span className={styles.label}>병명</span> {patientInfo.diseaseName || '정보 없음'}</p>
              <p><span className={styles.label}>간병 요청 지역</span> {patientInfo.reservationLocation || '정보 없음'}</p>
